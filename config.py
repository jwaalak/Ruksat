...
# ------------------------------------------------
API_ID = int(os.environ.get("API_ID", "18174360"))
# ------------------------------------------------
API_HASH = os.environ.get("API_HASH","c330c197c20412ccbe1be505063b6484")
# ------------------------------------------------
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8355221937:AAEXV3fUHFjMcR49KN3XjiPW1gcgehhbH-w")
# ------------------------------------------------
BOT_USERNAME = os.environ.get("BOT_USERNAME", "@Ruksat_BOT")
BOT_TEXT = "Ruksat"
# ------------------------------------------------
OWNER_ID = int(os.environ.get("OWNER_ID", "815349414"))
# ------------------------------------------------
# //LOG CHANNEL ID 
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002821511998"))

# //FORCE_CHANNEL_ID
CHANNEL_ID2 = int(os.environ.get("CHANNEL_ID2", "-1002932491778")) 
# ------------------------------------------------
...
# -----------------------------------------------
PREMIUM_LOGS = int(os.environ.get("PREMIUM_LOGS", "1-1002821511998"))
# -----------------------------------------------
